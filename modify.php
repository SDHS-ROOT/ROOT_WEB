            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="notice.html">게시판</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="가입신청.html">가입신청</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="로그인.html">로그인</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="회원가입.html">회원가입</a></li></ul>
                </div>
            </div>
        </nav>
        <br />
        ...
        <div id="board_write" class="text-center">            
            ...
            <div id="write_area">
                <form action="modify_input.php?id=<?php echo $bno; ?>" method="post">
                    <div id="in_title">
                        <textarea name="title" id="utitle" cols="55" rows="1" autocomplete="off" placeholder="제목" maxlength="100" required style="border-radius: 10px;"><?php echo $board['title']; ?></textarea>
                    </div>
                    <br>
                    ...
                    <div class="wi_line"></div>
                    <div id="in_content">
                        <textarea name="content" id="ucontent" cols="55" rows="12" placeholder="내용" autocomplete="off" required style="border-radius: 10px;"><?php echo $board['content']; ?></textarea>
                    </div>
                    <br>
                    <div class="bt_se">
